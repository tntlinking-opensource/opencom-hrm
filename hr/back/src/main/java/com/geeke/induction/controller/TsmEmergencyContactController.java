...
import com.geeke.induction.service.TsmEmergencyContactService;
 ...
 */
@RestController
@RequestMapping(value = "/induction/tsmEmergencyContact")
public class TsmEmergencyContactController extends BaseController {
    ...
    public ResponseEntity<JSONObject> getById(@PathVariable("id") String id) {
        TsmEmergencyContact entity = tsmEmergencyContactService.get(id);
    ...
    public ResponseEntity<JSONObject> listPage(@RequestBody SearchParams searchParams) {
        Page<TsmEmergencyContact> result = tsmEmergencyContactService.listPage(
    ...
    public ResponseEntity<JSONObject> listAll(@RequestBody SearchParams searchParams) {
        List<TsmEmergencyContact> result = tsmEmergencyContactService.listAll(
            searchParams.getParams(),
            searchParams.getOrderby()
        );
    ...
    public ResponseEntity<JSONObject> delete(@RequestBody TsmEmergencyContact entity) {
        int rows = tsmEmergencyContactService.delete(entity);
    ...
    public ResponseEntity<JSONObject> getByTaskId(@PathVariable("taskId") String taskId) {
        TsmEmergencyContact entity = tsmEmergencyContactService.getByTaskId(taskId);
        return ResponseEntity.ok(ResultUtil.successJson(entity));
    }
    ...
    public ResponseEntity<JSONObject> saveDraft(
        ...
        TsmEmergencyContact entity = JSONObject.parseObject(strEntity, TsmEmergencyContact.class);
        WfDraft wfDraft = JSONObject.parseObject(strDraft, WfDraft.class);
        int ret = tsmEmergencyContactService.saveDraft(wfDraft, entity, attachments);
    ...
    public ResponseEntity<JSONObject> save(@RequestBody List<TsmEmergencyContact> requestList) {
        List<TsmEmergencyContact> resultList = requestList.stream().map(tsmEmergencyContactService::save)
    ...
    public ResponseEntity<JSONObject> create(
        ...
        TsmEmergencyContact entity = JSONObject.parseObject(strEntity, TsmEmergencyContact.class);
        ActResult actResult = tsmEmergencyContactService.create(procDefId, entity, attachments);
    ...
    public ResponseEntity<JSONObject> reapply(
        ...
        TsmEmergencyContact entity = JSONObject.parseObject(strEntity, TsmEmergencyContact.class);
        ActResult actResult = tsmEmergencyContactService.reapply(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> agree(
        ...
        TsmEmergencyContact entity = JSONObject.parseObject(strEntity, TsmEmergencyContact.class);
        ActResult actResult = tsmEmergencyContactService.agree(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> forward(
        ...
        TsmEmergencyContact entity = JSONObject.parseObject(strEntity, TsmEmergencyContact.class);
        ActResult actResult = tsmEmergencyContactService.forward(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> commission(
        ...
        TsmEmergencyContact entity = JSONObject.parseObject(strEntity, TsmEmergencyContact.class);
        ActResult actResult = tsmEmergencyContactService.commission(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> propose(
        ...
        TsmEmergencyContact entity = JSONObject.parseObject(strEntity, TsmEmergencyContact.class);
        ActResult actResult = tsmEmergencyContactService.propose(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> back(
        ...
        TsmEmergencyContact entity = JSONObject.parseObject(strEntity, TsmEmergencyContact.class);
        ActResult actResult = tsmEmergencyContactService.back(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> reject(
        ...
        TsmEmergencyContact entity = JSONObject.parseObject(strEntity, TsmEmergencyContact.class);
        ActResult actResult = tsmEmergencyContactService.reject(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> terminate(
        ...
        TsmEmergencyContact entity = JSONObject.parseObject(strEntity, TsmEmergencyContact.class);
        int rows = tsmEmergencyContactService.terminate(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(rows));
    }
    ...
    public ResponseEntity<JSONObject> reverse(@PathVariable("taskId") String taskId) {
        TsmEmergencyContact entity = tsmEmergencyContactService.getByTaskId(taskId);
        ActResult actResult = tsmEmergencyContactService.reverse(taskId, entity);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> listBackActivity(@PathVariable("taskId") String taskId) {
        ActResult actResult = tsmEmergencyContactService.listBackActivity(taskId);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
}
