 ...
 */
@RestController
@RequestMapping(value = "/induction/tsmPersonalSkills")
public class TsmPersonalSkillsController extends BaseController {
    ...
    public ResponseEntity<JSONObject> getById(@PathVariable("id") String id) {
        TsmPersonalSkills entity = tsmPersonalSkillsService.get(id);
    ...
    public ResponseEntity<JSONObject> listPage(@RequestBody SearchParams searchParams) {
        Page<TsmPersonalSkills> result = tsmPersonalSkillsService.listPage(
    ...
    public ResponseEntity<JSONObject> listAll(@RequestBody SearchParams searchParams) {
        List<TsmPersonalSkills> result = tsmPersonalSkillsService.listAll(searchParams.getParams(), searchParams.getOrderby());

        return ResponseEntity.ok(ResultUtil.successJson(result));
    }

    @PostMapping(value = "delete")
    public ResponseEntity<JSONObject> delete(@RequestBody TsmPersonalSkills entity) {
        int rows = tsmPersonalSkillsService.delete(entity);
    ...
    public ResponseEntity<JSONObject> getByTaskId(@PathVariable("taskId") String taskId) {
        TsmPersonalSkills entity = tsmPersonalSkillsService.getByTaskId(taskId);
        return ResponseEntity.ok(ResultUtil.successJson(entity));
    }
    ...
    public ResponseEntity<JSONObject> saveDraft(
        ...
        TsmPersonalSkills entity = JSONObject.parseObject(strEntity, TsmPersonalSkills.class);
        WfDraft wfDraft = JSONObject.parseObject(strDraft, WfDraft.class);
        int ret = tsmPersonalSkillsService.saveDraft(wfDraft, entity, attachments);
    ...
    public ResponseEntity<JSONObject> save(@RequestBody List<TsmPersonalSkills> requestList) {
        List<TsmPersonalSkills> resultList = requestList.stream().map(tsmPersonalSkillsService::save)
    ...
    public ResponseEntity<JSONObject> create(
        ...
        TsmPersonalSkills entity = JSONObject.parseObject(strEntity, TsmPersonalSkills.class);
        ActResult actResult = tsmPersonalSkillsService.create(procDefId, entity, attachments);
    ...
    public ResponseEntity<JSONObject> reapply(
        ...
        TsmPersonalSkills entity = JSONObject.parseObject(strEntity, TsmPersonalSkills.class);
        ActResult actResult = tsmPersonalSkillsService.reapply(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> agree(
        ...
        TsmPersonalSkills entity = JSONObject.parseObject(strEntity, TsmPersonalSkills.class);
        ActResult actResult = tsmPersonalSkillsService.agree(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> forward(
        ...
        TsmPersonalSkills entity = JSONObject.parseObject(strEntity, TsmPersonalSkills.class);
        ActResult actResult = tsmPersonalSkillsService.forward(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> commission(
        ...
        TsmPersonalSkills entity = JSONObject.parseObject(strEntity, TsmPersonalSkills.class);
        ActResult actResult = tsmPersonalSkillsService.commission(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> propose(
        ...
        TsmPersonalSkills entity = JSONObject.parseObject(strEntity, TsmPersonalSkills.class);
        ActResult actResult = tsmPersonalSkillsService.propose(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> back(
        ...
        TsmPersonalSkills entity = JSONObject.parseObject(strEntity, TsmPersonalSkills.class);
        ActResult actResult = tsmPersonalSkillsService.back(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> reject(
        ...
        TsmPersonalSkills entity = JSONObject.parseObject(strEntity, TsmPersonalSkills.class);
        ActResult actResult = tsmPersonalSkillsService.reject(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> terminate(
        ...
        TsmPersonalSkills entity = JSONObject.parseObject(strEntity, TsmPersonalSkills.class);
        int rows = tsmPersonalSkillsService.terminate(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(rows));
    }
    ...
    public ResponseEntity<JSONObject> reverse(@PathVariable("taskId") String taskId) {
        TsmPersonalSkills entity = tsmPersonalSkillsService.getByTaskId(taskId);
        ActResult actResult = tsmPersonalSkillsService.reverse(taskId, entity);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> listBackActivity(@PathVariable("taskId") String taskId) {
        ActResult actResult = tsmPersonalSkillsService.listBackActivity(taskId);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
}
