...
import com.geeke.induction.service.TsmAssetInformationService;
 ...
 */
@RestController
@RequestMapping(value = "/induction/tsmAssetInformation")
public class TsmAssetInformationController extends BaseController {
    ...
    public ResponseEntity<JSONObject> getById(@PathVariable("id") String id) {
        TsmAssetInformation entity = tsmAssetInformationService.get(id);
    ...
    public ResponseEntity<JSONObject> listPage(@RequestBody SearchParams searchParams) {
        Page<TsmAssetInformation> result = tsmAssetInformationService.listPage(
    ...
    public ResponseEntity<JSONObject> listAll(@RequestBody SearchParams searchParams) {
        List<TsmAssetInformation> result = tsmAssetInformationService.listAll(
            searchParams.getParams(),
            searchParams.getOrderby()
        );
    ...
    public ResponseEntity<JSONObject> delete(@RequestBody TsmAssetInformation entity) {
        int rows = tsmAssetInformationService.delete(entity);
    ...
    public ResponseEntity<JSONObject> getByTaskId(@PathVariable("taskId") String taskId) {
        TsmAssetInformation entity = tsmAssetInformationService.getByTaskId(taskId);
        return ResponseEntity.ok(ResultUtil.successJson(entity));
    }
    ...
    public ResponseEntity<JSONObject> saveDraft(
        ...
        TsmAssetInformation entity = JSONObject.parseObject(strEntity, TsmAssetInformation.class);
        WfDraft wfDraft = JSONObject.parseObject(strDraft, WfDraft.class);
        int ret = tsmAssetInformationService.saveDraft(wfDraft, entity, attachments);
    ...
    public ResponseEntity<JSONObject> create(
        ...
        TsmAssetInformation entity = JSONObject.parseObject(strEntity, TsmAssetInformation.class);
        ActResult actResult = tsmAssetInformationService.create(procDefId, entity, attachments);
    ...
    public ResponseEntity<JSONObject> reapply(
        ...
        TsmAssetInformation entity = JSONObject.parseObject(strEntity, TsmAssetInformation.class);
        ActResult actResult = tsmAssetInformationService.reapply(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> agree(
        ...
        TsmAssetInformation entity = JSONObject.parseObject(strEntity, TsmAssetInformation.class);
        ActResult actResult = tsmAssetInformationService.agree(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> forward(
        ...
        TsmAssetInformation entity = JSONObject.parseObject(strEntity, TsmAssetInformation.class);
        ActResult actResult = tsmAssetInformationService.forward(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> commission(
        ...
        TsmAssetInformation entity = JSONObject.parseObject(strEntity, TsmAssetInformation.class);
        ActResult actResult = tsmAssetInformationService.commission(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> propose(
        ...
        TsmAssetInformation entity = JSONObject.parseObject(strEntity, TsmAssetInformation.class);
        ActResult actResult = tsmAssetInformationService.propose(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> back(
        ...
        TsmAssetInformation entity = JSONObject.parseObject(strEntity, TsmAssetInformation.class);
        ActResult actResult = tsmAssetInformationService.back(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> reject(
        ...
        TsmAssetInformation entity = JSONObject.parseObject(strEntity, TsmAssetInformation.class);
        ActResult actResult = tsmAssetInformationService.reject(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> terminate(
        ...
        TsmAssetInformation entity = JSONObject.parseObject(strEntity, TsmAssetInformation.class);
        int rows = tsmAssetInformationService.terminate(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(rows));
    }
    ...
    public ResponseEntity<JSONObject> reverse(@PathVariable("taskId") String taskId) {
        TsmAssetInformation entity = tsmAssetInformationService.getByTaskId(taskId);
        ActResult actResult = tsmAssetInformationService.reverse(taskId, entity);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> listBackActivity(@PathVariable("taskId") String taskId) {
        ActResult actResult = tsmAssetInformationService.listBackActivity(taskId);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
}
