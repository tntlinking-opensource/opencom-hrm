...
import com.geeke.induction.service.TsmCardService;
 ...
 */
@RestController
@RequestMapping(value = "/induction/tsmCard")
public class TsmCardController extends BaseController {
    ...
    public ResponseEntity<JSONObject> getById(@PathVariable("id") String id) {
        TsmCard entity = tsmCardService.get(id);
    ...
    public ResponseEntity<JSONObject> listPage(@RequestBody SearchParams searchParams) {
        Page<TsmCard> result = tsmCardService.listPage(
    ...
    public ResponseEntity<JSONObject> listAll(@RequestBody SearchParams searchParams) {
        List<TsmCard> result = tsmCardService.listAll(searchParams.getParams(), searchParams.getOrderby());

        return ResponseEntity.ok(ResultUtil.successJson(result));
    }

    @PostMapping(value = "delete")
    public ResponseEntity<JSONObject> delete(@RequestBody TsmCard entity) {
        int rows = tsmCardService.delete(entity);
    ...
    public ResponseEntity<JSONObject> getByTaskId(@PathVariable("taskId") String taskId) {
        TsmCard entity = tsmCardService.getByTaskId(taskId);
        return ResponseEntity.ok(ResultUtil.successJson(entity));
    }
    ...
    public ResponseEntity<JSONObject> saveDraft(
        ...
        TsmCard entity = JSONObject.parseObject(strEntity, TsmCard.class);
        WfDraft wfDraft = JSONObject.parseObject(strDraft, WfDraft.class);
        int ret = tsmCardService.saveDraft(wfDraft, entity, attachments);
    ...
    public ResponseEntity<JSONObject> create(
        ...
        TsmCard entity = JSONObject.parseObject(strEntity, TsmCard.class);
        ActResult actResult = tsmCardService.create(procDefId, entity, attachments);
    ...
    public ResponseEntity<JSONObject> reapply(
        ...
        TsmCard entity = JSONObject.parseObject(strEntity, TsmCard.class);
        ActResult actResult = tsmCardService.reapply(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> agree(
        ...
        TsmCard entity = JSONObject.parseObject(strEntity, TsmCard.class);
        ActResult actResult = tsmCardService.agree(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> forward(
        ...
        TsmCard entity = JSONObject.parseObject(strEntity, TsmCard.class);
        ActResult actResult = tsmCardService.forward(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> commission(
        ...
        TsmCard entity = JSONObject.parseObject(strEntity, TsmCard.class);
        ActResult actResult = tsmCardService.commission(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> propose(
        ...
        TsmCard entity = JSONObject.parseObject(strEntity, TsmCard.class);
        ActResult actResult = tsmCardService.propose(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> back(
        ...
        TsmCard entity = JSONObject.parseObject(strEntity, TsmCard.class);
        ActResult actResult = tsmCardService.back(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> reject(
        ...
        TsmCard entity = JSONObject.parseObject(strEntity, TsmCard.class);
        ActResult actResult = tsmCardService.reject(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> terminate(
        ...
        TsmCard entity = JSONObject.parseObject(strEntity, TsmCard.class);
        int rows = tsmCardService.terminate(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(rows));
    }
    ...
    public ResponseEntity<JSONObject> reverse(@PathVariable("taskId") String taskId) {
        TsmCard entity = tsmCardService.getByTaskId(taskId);
        ActResult actResult = tsmCardService.reverse(taskId, entity);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> listBackActivity(@PathVariable("taskId") String taskId) {
        ActResult actResult = tsmCardService.listBackActivity(taskId);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
}
