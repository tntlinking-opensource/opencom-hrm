...
import com.geeke.induction.service.TsmFamilyMemberInfoService;
 ...
 */
@RestController
@RequestMapping(value = "/induction/tsmFamilyMemberInfo")
public class TsmFamilyMemberInfoController extends BaseController {
    ...
    public ResponseEntity<JSONObject> getById(@PathVariable("id") String id) {
        TsmFamilyMemberInfo entity = tsmFamilyMemberInfoService.get(id);
    ...
    public ResponseEntity<JSONObject> listPage(@RequestBody SearchParams searchParams) {
        Page<TsmFamilyMemberInfo> result = tsmFamilyMemberInfoService.listPage(
    ...
    public ResponseEntity<JSONObject> listAll(@RequestBody SearchParams searchParams) {
        List<TsmFamilyMemberInfo> result = tsmFamilyMemberInfoService.listAll(
            searchParams.getParams(),
            searchParams.getOrderby()
        );
    ...
    public ResponseEntity<JSONObject> delete(@RequestBody TsmFamilyMemberInfo entity) {
        int rows = tsmFamilyMemberInfoService.delete(entity);
    ...
    public ResponseEntity<JSONObject> getByTaskId(@PathVariable("taskId") String taskId) {
        TsmFamilyMemberInfo entity = tsmFamilyMemberInfoService.getByTaskId(taskId);
        return ResponseEntity.ok(ResultUtil.successJson(entity));
    }
    ...
    public ResponseEntity<JSONObject> saveDraft(
        ...
        TsmFamilyMemberInfo entity = JSONObject.parseObject(strEntity, TsmFamilyMemberInfo.class);
        WfDraft wfDraft = JSONObject.parseObject(strDraft, WfDraft.class);
        int ret = tsmFamilyMemberInfoService.saveDraft(wfDraft, entity, attachments);
    ...
    public ResponseEntity<JSONObject> save(@RequestBody List<TsmFamilyMemberInfo> requestList) {
        List<TsmFamilyMemberInfo> resultList = requestList.stream().map(tsmFamilyMemberInfoService::save)
    ...
    public ResponseEntity<JSONObject> create(
        ...
        TsmFamilyMemberInfo entity = JSONObject.parseObject(strEntity, TsmFamilyMemberInfo.class);
        ActResult actResult = tsmFamilyMemberInfoService.create(procDefId, entity, attachments);
    ...
    public ResponseEntity<JSONObject> reapply(
        ...
        TsmFamilyMemberInfo entity = JSONObject.parseObject(strEntity, TsmFamilyMemberInfo.class);
        ActResult actResult = tsmFamilyMemberInfoService.reapply(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> agree(
        ...
        TsmFamilyMemberInfo entity = JSONObject.parseObject(strEntity, TsmFamilyMemberInfo.class);
        ActResult actResult = tsmFamilyMemberInfoService.agree(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> forward(
        ...
        TsmFamilyMemberInfo entity = JSONObject.parseObject(strEntity, TsmFamilyMemberInfo.class);
        ActResult actResult = tsmFamilyMemberInfoService.forward(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> commission(
        ...
        TsmFamilyMemberInfo entity = JSONObject.parseObject(strEntity, TsmFamilyMemberInfo.class);
        ActResult actResult = tsmFamilyMemberInfoService.commission(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> propose(
        ...
        TsmFamilyMemberInfo entity = JSONObject.parseObject(strEntity, TsmFamilyMemberInfo.class);
        ActResult actResult = tsmFamilyMemberInfoService.propose(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> back(
        ...
        TsmFamilyMemberInfo entity = JSONObject.parseObject(strEntity, TsmFamilyMemberInfo.class);
        ActResult actResult = tsmFamilyMemberInfoService.back(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> reject(
        ...
        TsmFamilyMemberInfo entity = JSONObject.parseObject(strEntity, TsmFamilyMemberInfo.class);
        ActResult actResult = tsmFamilyMemberInfoService.reject(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> terminate(
        ...
        TsmFamilyMemberInfo entity = JSONObject.parseObject(strEntity, TsmFamilyMemberInfo.class);
        int rows = tsmFamilyMemberInfoService.terminate(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(rows));
    }
    ...
    public ResponseEntity<JSONObject> reverse(@PathVariable("taskId") String taskId) {
        TsmFamilyMemberInfo entity = tsmFamilyMemberInfoService.getByTaskId(taskId);
        ActResult actResult = tsmFamilyMemberInfoService.reverse(taskId, entity);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> listBackActivity(@PathVariable("taskId") String taskId) {
        ActResult actResult = tsmFamilyMemberInfoService.listBackActivity(taskId);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
}
