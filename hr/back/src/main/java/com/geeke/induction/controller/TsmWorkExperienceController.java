 ...
 */
@RestController
@RequestMapping(value = "/induction/tsmWorkExperience")
public class TsmWorkExperienceController extends BaseController {
    ...
    public ResponseEntity<JSONObject> getById(@PathVariable("id") String id) {
        TsmWorkExperience entity = tsmWorkExperienceService.get(id);
    ...
    public ResponseEntity<JSONObject> listPage(@RequestBody SearchParams searchParams) {
        Page<TsmWorkExperience> result = tsmWorkExperienceService.listPage(
    ...
    public ResponseEntity<JSONObject> listAll(@RequestBody SearchParams searchParams) {
        List<TsmWorkExperience> result = tsmWorkExperienceService.listAll(searchParams.getParams(), searchParams.getOrderby());

        return ResponseEntity.ok(ResultUtil.successJson(result));
    }

    @PostMapping(value = "delete")
    public ResponseEntity<JSONObject> delete(@RequestBody TsmWorkExperience entity) {
        int rows = tsmWorkExperienceService.delete(entity);
    ...
    public ResponseEntity<JSONObject> getByTaskId(@PathVariable("taskId") String taskId) {
        TsmWorkExperience entity = tsmWorkExperienceService.getByTaskId(taskId);
        return ResponseEntity.ok(ResultUtil.successJson(entity));
    }
    ...
    public ResponseEntity<JSONObject> saveDraft(
        ...
        TsmWorkExperience entity = JSONObject.parseObject(strEntity, TsmWorkExperience.class);
        WfDraft wfDraft = JSONObject.parseObject(strDraft, WfDraft.class);
        int ret = tsmWorkExperienceService.saveDraft(wfDraft, entity, attachments);
    ...
    public ResponseEntity<JSONObject> save(@RequestBody List<TsmWorkExperience> requestList) {
        List<TsmWorkExperience> resultList = requestList.stream().map(tsmWorkExperienceService::save)
    ...
    public ResponseEntity<JSONObject> create(
        ...
        TsmWorkExperience entity = JSONObject.parseObject(strEntity, TsmWorkExperience.class);
        ActResult actResult = tsmWorkExperienceService.create(procDefId, entity, attachments);
    ...
    public ResponseEntity<JSONObject> reapply(
        ...
        TsmWorkExperience entity = JSONObject.parseObject(strEntity, TsmWorkExperience.class);
        ActResult actResult = tsmWorkExperienceService.reapply(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> agree(
        ...
        TsmWorkExperience entity = JSONObject.parseObject(strEntity, TsmWorkExperience.class);
        ActResult actResult = tsmWorkExperienceService.agree(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> forward(
        ...
        TsmWorkExperience entity = JSONObject.parseObject(strEntity, TsmWorkExperience.class);
        ActResult actResult = tsmWorkExperienceService.forward(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> commission(
        ...
        TsmWorkExperience entity = JSONObject.parseObject(strEntity, TsmWorkExperience.class);
        ActResult actResult = tsmWorkExperienceService.commission(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> propose(
        ...
        TsmWorkExperience entity = JSONObject.parseObject(strEntity, TsmWorkExperience.class);
        ActResult actResult = tsmWorkExperienceService.propose(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> back(
        ...
        TsmWorkExperience entity = JSONObject.parseObject(strEntity, TsmWorkExperience.class);
        ActResult actResult = tsmWorkExperienceService.back(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> reject(
        ...
        TsmWorkExperience entity = JSONObject.parseObject(strEntity, TsmWorkExperience.class);
        ActResult actResult = tsmWorkExperienceService.reject(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> terminate(
        ...
        TsmWorkExperience entity = JSONObject.parseObject(strEntity, TsmWorkExperience.class);
        int rows = tsmWorkExperienceService.terminate(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(rows));
    }
    ...
    public ResponseEntity<JSONObject> reverse(@PathVariable("taskId") String taskId) {
        TsmWorkExperience entity = tsmWorkExperienceService.getByTaskId(taskId);
        ActResult actResult = tsmWorkExperienceService.reverse(taskId, entity);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> listBackActivity(@PathVariable("taskId") String taskId) {
        ActResult actResult = tsmWorkExperienceService.listBackActivity(taskId);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
}
