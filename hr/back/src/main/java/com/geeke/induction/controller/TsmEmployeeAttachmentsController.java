...
import com.geeke.induction.service.TsmEmployeeAttachmentsService;
 ...
 */
@RestController
@RequestMapping(value = "/induction/tsmEmployeeAttachments")
public class TsmEmployeeAttachmentsController extends BaseController {
    ...
    public ResponseEntity<JSONObject> getById(@PathVariable("id") String id) {
        TsmEmployeeAttachments entity = tsmEmployeeAttachmentsService.get(id);
    ...
    public ResponseEntity<JSONObject> listPage(@RequestBody SearchParams searchParams) {
        Page<TsmEmployeeAttachments> result = tsmEmployeeAttachmentsService.listPage(
    ...
    public ResponseEntity<JSONObject> listAll(@RequestBody SearchParams searchParams) {
        List<TsmEmployeeAttachments> result = tsmEmployeeAttachmentsService.listAll(
            searchParams.getParams(),
            searchParams.getOrderby()
        );
    ...
    public ResponseEntity<JSONObject> delete(@RequestBody TsmEmployeeAttachments entity) {
        int rows = tsmEmployeeAttachmentsService.delete(entity);
    ...
    public ResponseEntity<JSONObject> getByTaskId(@PathVariable("taskId") String taskId) {
        TsmEmployeeAttachments entity = tsmEmployeeAttachmentsService.getByTaskId(taskId);
        return ResponseEntity.ok(ResultUtil.successJson(entity));
    }
    ...
    public ResponseEntity<JSONObject> saveDraft(
        ...
        TsmEmployeeAttachments entity = JSONObject.parseObject(strEntity, TsmEmployeeAttachments.class);
        WfDraft wfDraft = JSONObject.parseObject(strDraft, WfDraft.class);
        int ret = tsmEmployeeAttachmentsService.saveDraft(wfDraft, entity, attachments);
    ...
    public ResponseEntity<JSONObject> create(
        ...
        TsmEmployeeAttachments entity = JSONObject.parseObject(strEntity, TsmEmployeeAttachments.class);
        ActResult actResult = tsmEmployeeAttachmentsService.create(procDefId, entity, attachments);
    ...
    public ResponseEntity<JSONObject> reapply(
        ...
        TsmEmployeeAttachments entity = JSONObject.parseObject(strEntity, TsmEmployeeAttachments.class);
        ActResult actResult = tsmEmployeeAttachmentsService.reapply(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> agree(
        ...
        TsmEmployeeAttachments entity = JSONObject.parseObject(strEntity, TsmEmployeeAttachments.class);
        ActResult actResult = tsmEmployeeAttachmentsService.agree(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> forward(
        ...
        TsmEmployeeAttachments entity = JSONObject.parseObject(strEntity, TsmEmployeeAttachments.class);
        ActResult actResult = tsmEmployeeAttachmentsService.forward(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> commission(
        ...
        TsmEmployeeAttachments entity = JSONObject.parseObject(strEntity, TsmEmployeeAttachments.class);
        ActResult actResult = tsmEmployeeAttachmentsService.commission(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> propose(
        ...
        TsmEmployeeAttachments entity = JSONObject.parseObject(strEntity, TsmEmployeeAttachments.class);
        ActResult actResult = tsmEmployeeAttachmentsService.propose(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> back(
        ...
        TsmEmployeeAttachments entity = JSONObject.parseObject(strEntity, TsmEmployeeAttachments.class);
        ActResult actResult = tsmEmployeeAttachmentsService.back(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> reject(
        ...
        TsmEmployeeAttachments entity = JSONObject.parseObject(strEntity, TsmEmployeeAttachments.class);
        ActResult actResult = tsmEmployeeAttachmentsService.reject(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> terminate(
        ...
        TsmEmployeeAttachments entity = JSONObject.parseObject(strEntity, TsmEmployeeAttachments.class);
        int rows = tsmEmployeeAttachmentsService.terminate(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(rows));
    }
    ...
    public ResponseEntity<JSONObject> reverse(@PathVariable("taskId") String taskId) {
        TsmEmployeeAttachments entity = tsmEmployeeAttachmentsService.getByTaskId(taskId);
        ActResult actResult = tsmEmployeeAttachmentsService.reverse(taskId, entity);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> listBackActivity(@PathVariable("taskId") String taskId) {
        ActResult actResult = tsmEmployeeAttachmentsService.listBackActivity(taskId);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
}
