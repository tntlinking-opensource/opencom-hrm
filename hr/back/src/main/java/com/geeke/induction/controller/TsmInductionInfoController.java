 ...
 */
@RestController
@RequestMapping(value = "/induction/tsmInductionInfo")
public class TsmInductionInfoController extends BaseController {
    ...
    public ResponseEntity<JSONObject> getById(@PathVariable("id") String id) {
        TsmInductionInfo entity = tsmInductionInfoService.get(id);
    ...
    public ResponseEntity<JSONObject> listPage(@RequestBody SearchParams searchParams) {
        Page<TsmInductionInfo> result = tsmInductionInfoService.listPage(
    ...
    public ResponseEntity<JSONObject> listAll(@RequestBody SearchParams searchParams) {
        List<TsmInductionInfo> result = tsmInductionInfoService.listAll(searchParams.getParams(), searchParams.getOrderby());

        return ResponseEntity.ok(ResultUtil.successJson(result));
    }

    @PostMapping(value = "delete")
    public ResponseEntity<JSONObject> delete(@RequestBody TsmInductionInfo entity) {
        int rows = tsmInductionInfoService.delete(entity);
    ...
    public ResponseEntity<JSONObject> getByTaskId(@PathVariable("taskId") String taskId) {
        TsmInductionInfo entity = tsmInductionInfoService.getByTaskId(taskId);
        return ResponseEntity.ok(ResultUtil.successJson(entity));
    }
    ...
    public ResponseEntity<JSONObject> saveDraft(
        ...
        TsmInductionInfo entity = JSONObject.parseObject(strEntity, TsmInductionInfo.class);
        WfDraft wfDraft = JSONObject.parseObject(strDraft, WfDraft.class);
        int ret = tsmInductionInfoService.saveDraft(wfDraft, entity, attachments);
    ...
    public ResponseEntity<JSONObject> create(
        ...
        TsmInductionInfo entity = JSONObject.parseObject(strEntity, TsmInductionInfo.class);
        ActResult actResult = tsmInductionInfoService.create(procDefId, entity, attachments);
    ...
    public ResponseEntity<JSONObject> reapply(
        ...
        TsmInductionInfo entity = JSONObject.parseObject(strEntity, TsmInductionInfo.class);
        ActResult actResult = tsmInductionInfoService.reapply(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> agree(
        ...
        TsmInductionInfo entity = JSONObject.parseObject(strEntity, TsmInductionInfo.class);
        ActResult actResult = tsmInductionInfoService.agree(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> forward(
        ...
        TsmInductionInfo entity = JSONObject.parseObject(strEntity, TsmInductionInfo.class);
        ActResult actResult = tsmInductionInfoService.forward(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> commission(
        ...
        TsmInductionInfo entity = JSONObject.parseObject(strEntity, TsmInductionInfo.class);
        ActResult actResult = tsmInductionInfoService.commission(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> propose(
        ...
        TsmInductionInfo entity = JSONObject.parseObject(strEntity, TsmInductionInfo.class);
        ActResult actResult = tsmInductionInfoService.propose(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> back(
        ...
        TsmInductionInfo entity = JSONObject.parseObject(strEntity, TsmInductionInfo.class);
        ActResult actResult = tsmInductionInfoService.back(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> reject(
        ...
        TsmInductionInfo entity = JSONObject.parseObject(strEntity, TsmInductionInfo.class);
        ActResult actResult = tsmInductionInfoService.reject(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> terminate(
        ...
        TsmInductionInfo entity = JSONObject.parseObject(strEntity, TsmInductionInfo.class);
        int rows = tsmInductionInfoService.terminate(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(rows));
    }
    ...
    public ResponseEntity<JSONObject> reverse(@PathVariable("taskId") String taskId) {
        TsmInductionInfo entity = tsmInductionInfoService.getByTaskId(taskId);
        ActResult actResult = tsmInductionInfoService.reverse(taskId, entity);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> listBackActivity(@PathVariable("taskId") String taskId) {
        ActResult actResult = tsmInductionInfoService.listBackActivity(taskId);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
}
