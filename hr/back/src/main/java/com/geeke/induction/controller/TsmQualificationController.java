 ...
 */
@RestController
@RequestMapping(value = "/induction/tsmQualification")
public class TsmQualificationController extends BaseController {
    ...
    public ResponseEntity<JSONObject> getById(@PathVariable("id") String id) {
        TsmQualification entity = tsmQualificationService.get(id);
    ...
    public ResponseEntity<JSONObject> listPage(@RequestBody SearchParams searchParams) {
        Page<TsmQualification> result = tsmQualificationService.listPage(
    ...
    public ResponseEntity<JSONObject> listAll(@RequestBody SearchParams searchParams) {
        List<TsmQualification> result = tsmQualificationService.listAll(searchParams.getParams(), searchParams.getOrderby());

        return ResponseEntity.ok(ResultUtil.successJson(result));
    }

    @PostMapping(value = "delete")
    public ResponseEntity<JSONObject> delete(@RequestBody TsmQualification entity) {
        int rows = tsmQualificationService.delete(entity);
    ...
    public ResponseEntity<JSONObject> getByTaskId(@PathVariable("taskId") String taskId) {
        TsmQualification entity = tsmQualificationService.getByTaskId(taskId);
        return ResponseEntity.ok(ResultUtil.successJson(entity));
    }
    ...
    public ResponseEntity<JSONObject> saveDraft(
        ...
        TsmQualification entity = JSONObject.parseObject(strEntity, TsmQualification.class);
        WfDraft wfDraft = JSONObject.parseObject(strDraft, WfDraft.class);
        int ret = tsmQualificationService.saveDraft(wfDraft, entity, attachments);
    ...
    public ResponseEntity<JSONObject> save(@RequestBody List<TsmQualification> requestList) {
        List<TsmQualification> resultList = requestList.stream().map(tsmQualificationService::save)
    ...
    public ResponseEntity<JSONObject> create(
        ...
        TsmQualification entity = JSONObject.parseObject(strEntity, TsmQualification.class);
        ActResult actResult = tsmQualificationService.create(procDefId, entity, attachments);
    ...
    public ResponseEntity<JSONObject> reapply(
        ...
        TsmQualification entity = JSONObject.parseObject(strEntity, TsmQualification.class);
        ActResult actResult = tsmQualificationService.reapply(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> agree(
        ...
        TsmQualification entity = JSONObject.parseObject(strEntity, TsmQualification.class);
        ActResult actResult = tsmQualificationService.agree(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> forward(
        ...
        TsmQualification entity = JSONObject.parseObject(strEntity, TsmQualification.class);
        ActResult actResult = tsmQualificationService.forward(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> commission(
        ...
        TsmQualification entity = JSONObject.parseObject(strEntity, TsmQualification.class);
        ActResult actResult = tsmQualificationService.commission(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> propose(
        ...
        TsmQualification entity = JSONObject.parseObject(strEntity, TsmQualification.class);
        ActResult actResult = tsmQualificationService.propose(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> back(
        ...
        TsmQualification entity = JSONObject.parseObject(strEntity, TsmQualification.class);
        ActResult actResult = tsmQualificationService.back(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> reject(
        ...
        TsmQualification entity = JSONObject.parseObject(strEntity, TsmQualification.class);
        ActResult actResult = tsmQualificationService.reject(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> terminate(
        ...
        TsmQualification entity = JSONObject.parseObject(strEntity, TsmQualification.class);
        int rows = tsmQualificationService.terminate(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(rows));
    }
    ...
    public ResponseEntity<JSONObject> reverse(@PathVariable("taskId") String taskId) {
        TsmQualification entity = tsmQualificationService.getByTaskId(taskId);
        ActResult actResult = tsmQualificationService.reverse(taskId, entity);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> listBackActivity(@PathVariable("taskId") String taskId) {
        ActResult actResult = tsmQualificationService.listBackActivity(taskId);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
}
