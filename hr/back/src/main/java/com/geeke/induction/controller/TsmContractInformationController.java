 ...
 */
@RestController
@RequestMapping(value = "/induction/tsmContractInformation")
public class TsmContractInformationController extends BaseController {
    ...
    public ResponseEntity<JSONObject> getById(@PathVariable("id") String id) {
        TsmContractInformation entity = tsmContractInformationService.get(id);
    ...
    public ResponseEntity<JSONObject> listPage(@RequestBody SearchParams searchParams) {
        Page<TsmContractInformation> result = tsmContractInformationService.listPage(
    ...
    public ResponseEntity<JSONObject> listAll(@RequestBody SearchParams searchParams) {
        List<TsmContractInformation> result = tsmContractInformationService.listAll(
            searchParams.getParams(),
            searchParams.getOrderby()
        );
    ...
    public ResponseEntity<JSONObject> delete(@RequestBody TsmContractInformation entity) {
        int rows = tsmContractInformationService.delete(entity);
    ...
    public ResponseEntity<JSONObject> getByTaskId(@PathVariable("taskId") String taskId) {
        TsmContractInformation entity = tsmContractInformationService.getByTaskId(taskId);
        return ResponseEntity.ok(ResultUtil.successJson(entity));
    }
    ...
    public ResponseEntity<JSONObject> saveDraft(
        ...
        TsmContractInformation entity = JSONObject.parseObject(strEntity, TsmContractInformation.class);
        WfDraft wfDraft = JSONObject.parseObject(strDraft, WfDraft.class);
        int ret = tsmContractInformationService.saveDraft(wfDraft, entity, attachments);
    ...
    public ResponseEntity<JSONObject> create(
        ...
        TsmContractInformation entity = JSONObject.parseObject(strEntity, TsmContractInformation.class);
        ActResult actResult = tsmContractInformationService.create(procDefId, entity, attachments);
    ...
    public ResponseEntity<JSONObject> reapply(
        ...
        TsmContractInformation entity = JSONObject.parseObject(strEntity, TsmContractInformation.class);
        ActResult actResult = tsmContractInformationService.reapply(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> agree(
        ...
        TsmContractInformation entity = JSONObject.parseObject(strEntity, TsmContractInformation.class);
        ActResult actResult = tsmContractInformationService.agree(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> forward(
        ...
        TsmContractInformation entity = JSONObject.parseObject(strEntity, TsmContractInformation.class);
        ActResult actResult = tsmContractInformationService.forward(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> commission(
        ...
        TsmContractInformation entity = JSONObject.parseObject(strEntity, TsmContractInformation.class);
        ActResult actResult = tsmContractInformationService.commission(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> propose(
        ...
        TsmContractInformation entity = JSONObject.parseObject(strEntity, TsmContractInformation.class);
        ActResult actResult = tsmContractInformationService.propose(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> back(
        ...
        TsmContractInformation entity = JSONObject.parseObject(strEntity, TsmContractInformation.class);
        ActResult actResult = tsmContractInformationService.back(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> reject(
        ...
        TsmContractInformation entity = JSONObject.parseObject(strEntity, TsmContractInformation.class);
        ActResult actResult = tsmContractInformationService.reject(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> terminate(
        ...
        TsmContractInformation entity = JSONObject.parseObject(strEntity, TsmContractInformation.class);
        int rows = tsmContractInformationService.terminate(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(rows));
    }
    ...
    public ResponseEntity<JSONObject> reverse(@PathVariable("taskId") String taskId) {
        TsmContractInformation entity = tsmContractInformationService.getByTaskId(taskId);
        ActResult actResult = tsmContractInformationService.reverse(taskId, entity);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> listBackActivity(@PathVariable("taskId") String taskId) {
        ActResult actResult = tsmContractInformationService.listBackActivity(taskId);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
}
