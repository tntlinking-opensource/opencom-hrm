...
public class SalaryBatch extends DataEntity<SalaryBatch> {


    private static final long serialVersionUID = 1683007003934706055L;
    ...
    private String isVerify = "0";        // 是否数据确认　1：是　0：否
