...
import com.geeke.hrm.service.HrmUserLaidService;
 ...
 */
@RestController
@RequestMapping(value = "/hrm/hrmUserLaid")
public class HrmUserLaidController extends BaseController {

    @Autowired
    private HrmUserLaidService hrmUserLaidService;
    ...
    public ResponseEntity<JSONObject> getByTaskId(@PathVariable("taskId") String taskId) {
        HrmUserLaid entity = hrmUserLaidService.getByTaskId(taskId);
        return ResponseEntity.ok(ResultUtil.successJson(entity));
    }
    ...
    public ResponseEntity<JSONObject> saveDraft(
        ...
        HrmUserLaid entity = JSONObject.parseObject(strEntity, HrmUserLaid.class);
        WfDraft wfDraft = JSONObject.parseObject(strDraft, WfDraft.class);
        int ret = hrmUserLaidService.saveDraft(wfDraft, entity, attachments);
    ...
    public ResponseEntity<JSONObject> create(
        ...
        HrmUserLaid entity = JSONUtil.toBean(strEntity, HrmUserLaid.class);
        ActResult actResult = hrmUserLaidService.create(procDefId, entity, attachments);
    ...
    public ResponseEntity<JSONObject> reapply(
        ...
        HrmUserLaid entity = JSONObject.parseObject(strEntity, HrmUserLaid.class);
        ActResult actResult = hrmUserLaidService.reapply(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> agree(
        ...
        HrmUserLaid entity = JSONObject.parseObject(strEntity, HrmUserLaid.class);
        ActResult actResult = hrmUserLaidService.agree(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> forward(
        ...
        HrmUserLaid entity = JSONObject.parseObject(strEntity, HrmUserLaid.class);
        ActResult actResult = hrmUserLaidService.forward(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> commission(
        ...
        HrmUserLaid entity = JSONObject.parseObject(strEntity, HrmUserLaid.class);
        ActResult actResult = hrmUserLaidService.commission(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> propose(
        ...
        HrmUserLaid entity = JSONObject.parseObject(strEntity, HrmUserLaid.class);
        ActResult actResult = hrmUserLaidService.propose(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> back(
        ...
        HrmUserLaid entity = JSONObject.parseObject(strEntity, HrmUserLaid.class);
        ActResult actResult = hrmUserLaidService.back(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> reject(
        ...
        HrmUserLaid entity = JSONObject.parseObject(strEntity, HrmUserLaid.class);
        ActResult actResult = hrmUserLaidService.reject(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> terminate(
        ...
        HrmUserLaid entity = JSONObject.parseObject(strEntity, HrmUserLaid.class);
        int rows = hrmUserLaidService.terminate(taskId, entity, attachments);
        return ResponseEntity.ok(ResultUtil.successJson(rows));
    }
    ...
    public ResponseEntity<JSONObject> reverse(@PathVariable("taskId") String taskId) {
        HrmUserLaid entity = hrmUserLaidService.getByTaskId(taskId);
        ActResult actResult = hrmUserLaidService.reverse(taskId, entity);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
    ...
    public ResponseEntity<JSONObject> listBackActivity(@PathVariable("taskId") String taskId) {
        ActResult actResult = hrmUserLaidService.listBackActivity(taskId);
        return ResponseEntity.ok(ResultUtil.successJson(actResult));
    }
}
