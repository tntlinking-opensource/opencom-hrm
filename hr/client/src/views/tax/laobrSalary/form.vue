<template>
  <van-row class="dm-container">
    <el-dialog v-on:open="onDialogOpen" v-on:close="onDialogClose" v-loading="loading" width="85%" :fullscreen="false"
      ...
      <el-row>
        ...
        <el-form ref="editForm" :model="editFormData" label-width="120px" :disabled="action == 'view'"
          ...
          <el-row>
            ...
            <el-col :span="6"> <el-form-item prop="monthTaxIncome" :rules="[
              { required: true, message: '月纳税所得额不能为空', trigger: 'blur' }
            ]" label="月纳税所得额" class="dc-el-form-item_SingleInput">
                <number-input v-model="editFormData.monthTaxIncome" :precision="2" :maxLength="18" :min="0"
                  placeholder="请输入月纳税所得额" clearable autocomplete="new-password"
        ...
        <el-form ref="taxDetailsInfoForm" :model="editFormData" label-width="100px" :disabled="action == 'view'"
          ...
          <el-row>
            <ux-grid :data="editFormData.taxDetailsInfoList" ref="taxDetailsInfoTable" :currentRow="table124CurrentRow"
              ...
              <ux-table-column field="rateLevel" title="速率级次" tree-node resizable min-width="80px" align="left"
              ...
              <ux-table-column field="monthTaxAmount" title="月纳所得税" tree-node resizable min-width="110px" align="left"
                header-align="center" show-overflow :edit-render="{ autofocus: '.el-input__inner' }"
                class="dc-ux-table-column_SingleInput">
                <template v-slot:header="{ column }">
                  <span style="color: #f56c6c">*</span>
                ...
                <template v-slot:edit="{ row, rowIndex }">
                  <el-form-item :prop="'taxDetailsInfoList.' + rowIndex + '.monthTaxAmount'" label-width="0px"
                    class="dc-el-form-item_SingleInput">
                    <el-input v-model="row.monthTaxAmount" :maxLength="18" placeholder="请输入月纳所得税" clearable :min="0"
                      autocomplete="new-password" class="dc-el-input_SingleInput"></el-input>
                  </el-form-item>
                </template>
                <template v-slot="{ row, rowIndex }">
              ...
              <ux-table-column field="amountDown" title="年终奖月平均下限" tree-node resizable min-width="150px" align="left"
                header-align="center" show-overflow :edit-render="{ autofocus: '.el-input__inner' }"
                class="dc-ux-table-column_SingleInput">
                <template v-slot:header="{ column }">
                  <span style="color: #f56c6c">*</span>
                ...
                <template v-slot:edit="{ row, rowIndex }">
                  <el-form-item :prop="'taxDetailsInfoList.' + rowIndex + '.amountDown'" label-width="0px"
                    class="dc-el-form-item_SingleInput">
                    <number-input v-model="row.amountDown" :min="0" :maxLength="18" :precision="2"
                      placeholder="请输入年终奖月平均下限" clearable autocomplete="new-password"
                      class="dc-el-input_SingleInput"></number-input>
                  </el-form-item>
                </template>
                <template v-slot="{ row, rowIndex }">
              ...
              <ux-table-column field="amountUp" title="年终奖月平均上限" tree-node resizable min-width="150px" align="left"
                header-align="center" show-overflow :edit-render="{ autofocus: '.el-input__inner' }"
                class="dc-ux-table-column_SingleInput">
                <template v-slot:header="{ column }">
                  <span style="color: #f56c6c">*</span>
                ...
                <template v-slot:edit="{ row, rowIndex }">
                  <el-form-item :prop="'taxDetailsInfoList.' + rowIndex + '.amountUp'" label-width="0px"
                    class="dc-el-form-item_SingleInput">
                    <number-input v-model="row.amountUp" :precision="2" :maxLength="18" placeholder="请输入年终奖月平均上限" :min="0"
              ...
              <ux-table-column field="freeTaxAmount" title="免税所得额" tree-node resizable min-width="120px" align="left"
                header-align="center" show-overflow :edit-render="{ autofocus: '.el-input__inner' }"
                class="dc-ux-table-column_SingleInput">
                <template v-slot:header="{ column }">
                  <span style="color: #f56c6c">*</span>
                ...
                <template v-slot:edit="{ row, rowIndex }">
                  <el-form-item :prop="'taxDetailsInfoList.' + rowIndex + '.freeTaxAmount'" label-width="0px"
                    class="dc-el-form-item_SingleInput">
                    <el-input v-model="row.freeTaxAmount" placeholder="请输入免税所得额" clearable autocomplete="new-password"
              ...
              <ux-table-column field="rate" title="税率(%)" tree-node resizable min-width="100px" align="left"
                header-align="center" show-overflow :edit-render="{ autofocus: '.el-input__inner' }"
                class="dc-ux-table-column_SingleInput">
                <template v-slot:header="{ column }">
                  <span style="color: #f56c6c">*</span>
