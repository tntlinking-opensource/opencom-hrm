  ...
  <van-row class="dm-container">
    ...
    <el-form ref="queryForm" :model="queryFormData" style="padding-top: 20px;" label-width="120px"
      ...
      <el-row>
        ...
        <el-col :span="6">
          <el-form-item prop="actStatus" label="月平均金额>=:" class="dc-el-form-item_SelectInput">
            <number-input v-model="queryFormData.minAmount" :maxLength="64" placeholder="月平均金额>=" clearable :min="0"
              class="dc-el-input_SingleInput"></number-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item prop="recruitStatus" label="月平均金额<=:" class="dc-el-form-item_SelectInput">
            <number-input v-model="queryFormData.maxAmount" :maxLength="64" placeholder="月平均金额<=" clearable :min="0"
              class="dc-el-input_SingleInput"></number-input>
          </el-form-item>
        </el-col>
