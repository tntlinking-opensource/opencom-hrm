  ...
  <el-row class="dc-container">
    ...
    >
      <el-row>
        ...
        >
          <el-row>
            <el-form-item prop="attribute2" label="邮箱序号：" :rules="[{ required: true, message: '邮箱序号：不能为空', trigger: 'blur' }]" class="dc-el-form-item_SingleInput">
              <el-input
            ...
            <el-form-item prop="attribute0" label="邮箱地址："   :rules="[
                { required: true, message: '邮箱地址：不能为空', trigger: 'blur' },
                {
            ...
            <el-form-item prop="attribute1" label="邮箱密码：" :rules="[{ required: true, message: '邮箱密码：不能为空', trigger: 'blur' }]" class="dc-el-form-item_SingleInput">
              <el-input
