  ...
  <el-row class="dc-container">
    ...
    >
      <el-row>
        ...
        >
          <el-row>
            <el-form-item prop="attribute2" label="权限序号：" :rules="[{ required: true, message: '权限序号：不能为空', trigger: 'blur' }]" class="dc-el-form-item_SingleInput">
              <el-input
            ...
            <el-form-item prop="attribute0" label="权限名称：" :rules="[{ required: true, message: '权限名称：不能为空', trigger: 'blur' }]" class="dc-el-form-item_SingleInput">
              <el-input
