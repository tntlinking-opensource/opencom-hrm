const conditions = [
...

  {
    ...
    attribute: {
      labelField: 'name',
      className: 'HrmSalaryUploadSummary',
      fieldId: 'id',
      tableId: '1457254743943434067',
      apiPath: 'hrm/hrmSalaryUploadSummary',
      filter: ''
    }
  },
  ...
  {
    name: 'total_allowance_and_deduction',
    comments: '补扣款合计',
    tag: 'number-input',
    queryType: '=',
    operations: [
  ...
  {
    name: 'personal_social_insurance',
    comments: '社保小计(个人)',
    tag: 'number-input',
    queryType: '=',
    operations: [
  ...
  {
    name: 'personal_accumulation_fund',
    comments: '公积金小计(个人)',
    tag: 'number-input',
    queryType: '=',
    operations: [
