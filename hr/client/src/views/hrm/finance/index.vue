<template>
  <el-row class="dc-container" v-loading="loading">
    ...
    >
      ...
      ></ux-table-column>
      <ux-table-column
        :field="tableColumns['199'].field"
        :title="tableColumns['199'].title"
        :width="tableColumns['199'].width"
        :visible="tableColumns['199'].visible"
        :params="{ sortId: '199', summary: false }"
        tree-node
        resizable
        min-width="120px"
        align="center"
      ...
      >
        ...
        <template slot-scope="scope">
          ...
          <OperationIcon
            ...
            type="primary"
            v-show="permission.edit && scope.row.financeaffairsstatus === '1'"
            content="事务确认"
            placement="top"
      ...
      try {
        ...
        if (listHrmUserLaidRespData.code == 100 && listPermissionRespData.code == 100) {
          ...
          this.permission.view = listPermissionRespData.data.find((item) => {
            return item.permission === 'finance:read'
          })
          this.permission.export = listPermissionRespData.data.find((item) => {
            return item.permission === 'finance:export'
          })

          this.permission.add = listPermissionRespData.data.find((item) => {
            return item.permission === 'finance:create'
          })
          this.permission.edit = listPermissionRespData.data.find((item) => {
            return item.permission === 'finance:update'
          })
          this.permission.remove = listPermissionRespData.data.find((item) => {
            return item.permission === 'finance:delete'
          })
        } else {
