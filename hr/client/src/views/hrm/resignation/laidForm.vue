      ...
      <el-row>
        ...
        >
          <el-row>
            ...
            >
              <el-input
                v-model="editFormData.finalremark"
                type="textarea"
                placeholder="请在此处填写离职备注..."
                rows="4"
                :maxLength="100"
...
/** 根据用户界面配置import组件 结束 */
import { getHrmUserLaidById, saveHrmUserLaid,laidHrmUserLaid } from '@/api/hrm/hrmUserLaidCrud'
...
export default {
  ...
  methods: {
    ...
    doSave() {
      ...
      laidHrmUserLaid(this.editFormData)
        .then((responseData) => {
