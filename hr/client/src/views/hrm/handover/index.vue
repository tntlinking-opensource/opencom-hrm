      ...
      <el-row>
        <el-col :span="6">
          <el-form-item prop="handingstatus" label="交接状态" class="dc-el-form-item_SelectInput">
            ...
            >
              <el-option
                v-for="(handingStatus, index) in handingStatusOptions"
                :key="index"
                :label="handingStatus.label"
                :value="handingStatus.value"
              ></el-option>
            </el-select>
          </el-form-item>
        </el-col>
      ...
      >
        ...
        <template slot-scope="scope">
          ...
          <OperationIcon
            ...
            type="primary"
            v-show="permission.edit && scope.row.handingstatus === '0'"
            content="交接确认"
            placement="top"
      ...
      try {
        ...
        if (listHrmUserLaidRespData.code == 100 && listPermissionRespData.code == 100) {
          ...
          this.permission.view = listPermissionRespData.data.find((item) => {
            return item.permission === 'handover:read'
          })
          this.permission.export = listPermissionRespData.data.find((item) => {
            return item.permission === 'handover:export'
          })

          this.permission.add = listPermissionRespData.data.find((item) => {
            return item.permission === 'handover:create'
          })
          this.permission.edit = listPermissionRespData.data.find((item) => {
            return item.permission === 'handover:update'
          })
          this.permission.remove = listPermissionRespData.data.find((item) => {
            return item.permission === 'handover:delete'
          })
        } else {
